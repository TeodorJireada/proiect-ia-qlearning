...
class InvertedPendulumApp:
    ...
    def setup_plot(self):
        ...
        self.cart = patches.Rectangle((0, 0), self.cart_w, self.cart_h, fc='#3498db', ec='white', linewidth=2,
                                      zorder=10)
        ...
        self.ax.text(0, -0.8, '[T] Train/Demo | [S] Save | [R] Reset | [+/-] Speed', fontsize=10, color='#95a5a6',
                     ha='center')
        ...
        if event.key == 't':
            ...
            if os.path.exists(MODEL_FILE):
                try:
                    ...
                    print(f"Error reading model file for confirmation: {e}")
    ...
    def run(self):
        ...
        ani = animation.FuncAnimation(self.fig, self.update, frames=None, interval=20, blit=False,
